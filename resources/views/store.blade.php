...
<div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
        ...
        <ul class="list-unstyled px-3">
            ...
            <li class="active"><a href="{{url('/store')}}" class="text-decoration-none py-2 px-3 d-block"><i class="fa-solid fa-store pr-2"></i>Store</a></li>
...
{{--                            </div>--}}
                            ...
                            <form action="{{route('store.store')}}" method="POST">
                                ...
                                <input type="number" placeholder="Enter Quantity of Product" name="quantity"  required>
                        ...
                        <div class="table-responsive">
                            <table class="align-middle text-truncate mb-0 table table-borderless table-hover">
                                ...
                                <tr style="color:var(--black-color); transition: 0.3s">
                                    ...
                                    <th class="text-center col-3">Type</th>
                                ...
                                @foreach($stores as $store)
                                    <tr>
                                        <td class="text-center text-muted" style="width: 80px;">{{$store->id}}</td>
                                        <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$store->type}}</a></td>
                                        <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$store->quantity}}</a></td>
                                        <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$store->price}}</a></td>
                                        <td class="text-center d-flex justify-content-center">

                                            <a href="{{route('store.edit',$store->id)}}" class="text-success mr-2"><i class="fa-solid fa-pen-ruler"></i></a>
