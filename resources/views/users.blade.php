...
<div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
        ...
        <ul class="list-unstyled px-3">
            ...
            <li class="active"><a href="{{url('/users')}}" class="text-decoration-none py-2 px-3 d-block"><i class="fa-solid fa-users pr-2"></i>Users</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="align-middle text-truncate mb-0 table table-borderless table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$user->name}}</a></td>
                                    <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$user->email}}</a></td>
                                    <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$user->password}}</a></td>
                                    <td class="text-center d-flex">

                                        <a href="{{route('users.edit',$user->id)}}" class="text-success mr-2"><i class="fa-solid fa-pen-ruler"></i></a>
