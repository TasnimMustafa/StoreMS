...
<div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
        ...
        <ul class="list-unstyled px-3">
            ...
            <li class="active"><a href="{{url('/spends')}}" class="text-decoration-none py-2 px-3 d-block"><i class="fa-solid fa-money-check-dollar pr-2"></i>Spends</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="align-middle text-truncate mb-0 table table-borderless table-hover">
                                ...
                                <tr style="color:var(--black-color); transition: 0.3s">
                                    ...
                                    <th class="text-center col-2">Cost</th>
                                ...
                                @foreach($spends as $spend)
                                    <tr>
                                        <td class="text-center text-muted" style="width: 80px;">{{$spend->id}}</td>
                                        <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$spend->type}}</a></td>
                                        <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$spend->date}}</a></td>
                                        <td class="text-center" style="width: 80px;"><a href="#" class="text-decoration-none">{{$spend->cost}}</a></td>
                                        <td class="text-center d-flex justify-content-center">

                                            <a href="{{route('spends.edit',$spend->id)}}" class="text-success mr-2"><i class="fa-solid fa-pen-ruler"></i></a>
